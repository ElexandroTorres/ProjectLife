 ...
 * @return true caso seja possivel gerar a imagem e false caso contrario.
*/
...
class Life {
	...
	public:
		...
		*/
		void print();
		/*!
		 * Imprime a matriz de células em um arquivo.
		*/
		void print_file();
		/*!
		 * Gera uma imagem das celulas.
		 * @return False caso não seja possivel gerar a imagem no diretorio informado.
		*/
		bool generate_image();
		/*!
		...
		*/
		bool carregar_configuracoes(std::fstream &config);
		/*!
		...
		*/
		...
		/*!
		 * Valida os argumentos passados na linha de comando e imprime a mensagem de boas vindas. Finaliza a simulação caso eles sejam invalidos.
